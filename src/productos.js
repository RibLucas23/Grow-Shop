...
export const productosJson = [
    ...
    },
    {
        ...
        "url": `${panelLed}`,
        "descripcion": "Acerca de este producto: • Remplaza un sodio de 200Watt con 1/3 del consumo , ideal para espacios de hasta 60x60cm. • Un equipo profesional para cultivo, con el que obtendrás resultados inigualables. • Este producto cuenta con características superiores, fabricados con LED CREE de la linea MHB y XPE. • Luminaria IP65 soporta humedad y polvo, contando con una refrigeración pasiva es decir sin ventilador, haciéndolo totalmente silencioso. • Este equipo cuenta con un espectro lumínico completo, sirviendo tanto para crecimiento como para floración.",
        "precio": "23960",
    },
    {
        "id": 5,
